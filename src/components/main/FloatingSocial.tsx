...
export default function FloatingSocial() {
  ...
  return (
    <div className="fixed left-0 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-1.5">
      {socialLinks.map((link) => (
        <div key={link.name} className="group relative flex items-center">
          <a
            ...
            className={`w-10 h-10 flex items-center justify-center text-white rounded-r-lg shadow-md transition-all duration-200 hover:w-12 hover:pl-2 ${link.bgClass}`}
