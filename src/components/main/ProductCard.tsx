  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col gap-2">
        ...
        {/* Buttons (mt-auto, flex flex-row md:flex-col gap-1.5 md:gap-2 pt-2 md:pt-3) */}
        <div className="mt-auto flex flex-row md:flex-col gap-1.5 md:gap-2 pt-2 md:pt-3">
          <a
            href={whatsappUrl}
            target="_blank"
            rel="noopener noreferrer"
            onClick={(e) => e.stopPropagation()}
            className="bg-[#cc0000] hover:bg-[#aa0000] text-white rounded-lg md:rounded-xl py-2 md:py-2.5 flex-1 md:w-full font-bold text-[10px] md:text-[12px] flex items-center justify-center gap-1 md:gap-2 transition-colors duration-300"
          >
          ...
          <button
            ...
            className="border border-[#cc0000] md:border-2 text-[#cc0000] hover:bg-red-50 rounded-lg md:rounded-xl py-2 flex-1 md:w-full font-bold text-[10px] md:text-[12px] text-center bg-white transition-colors duration-300"
          >
