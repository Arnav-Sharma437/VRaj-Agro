        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-3.5 pt-2">
              {checkmarks.map((point, index) => (
                <div key={index} className="flex items-center gap-2">
                  ...
                  <span className="text-xs md:text-sm text-[#444444] font-bold uppercase tracking-wide">
                    {point}
                  </span>
                </div>
              ))}
            ...
            <div className="pt-4">
              <Link
                href="/about"
                className="inline-flex items-center justify-center bg-[#cc0000] hover:bg-[#aa0000] text-white px-7 py-3 rounded text-sm font-bold uppercase tracking-wider shadow hover:shadow-md transition-all duration-300 hover:translate-x-1"
              >
                Know More &rarr;
              </Link>
            </div>
